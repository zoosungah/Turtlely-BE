...
public enum MeasurementErrorCode implements BaseErrorCode {
    ...
    INVALID_DATE_PARAMETER(HttpStatus.BAD_REQUEST, "REPORT400_7", "유효하지 않은 연도 또는 월 값입니다."),
    REPORT_PROCESSING(HttpStatus.ACCEPTED, "REPORT202_1", "아직 AI 연산 처리가 완료되지 않음 (프론트 로딩 바 유지용)"),
    REPORT_NOT_FOUND(HttpStatus.NOT_FOUND, "REPORT404_1", "요청하신 리포트를 찾을 수 없음"),
    ...
    MeasurementErrorCode(HttpStatus status, String code, String message) {
        this.status = status;
        this.code = code;
