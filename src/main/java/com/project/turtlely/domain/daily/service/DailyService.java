...
public class DailyService {
    ...
    private int calculateTotalScore(int normalDuration, int totalDuration, int defaultScore) {
...
//        int finalScore = (int) Math.round(100 - penaltyRatio);
        ...
        // 정상 유지 시간 / 총 측정 시간 * 100
        double normalRatio = ((double) normalDuration / totalDuration) * 100.0;
        int finalScore = (int) Math.round(normalRatio);
